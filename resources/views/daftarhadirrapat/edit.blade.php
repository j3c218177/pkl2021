            ...
            <div class="animated fadeIn">
            	<div class="card">
            		...
            		<div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <form action="{{ route('daftarhadirrapats.update',['hadirrapat'=>$hadirrapat->id])}}" method="post">
                                    @method('PUT')
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        id="keterangan" name="keterangan" value="{{old('keterangan')??$hadirrapat->keterangan}}" 
                                        autofocus required>
                                        @error('keterangan')
                                    ...
                                    <div class="form-group">
                                        ...
                                        id="tanggal" name="tanggal" value="{{old('tanggal')??$hadirrapat->tanggal}}" 
                                        autofocus required>
                                        @error('tanggal')
                                            <div class="text-danger">{{$message}}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        id="pukul" name="pukul" value="{{old('pukul')??$hadirrapat->pukul}}" 
                                        autofocus required>
                                        @error('pukul')
                                            <div class="text-danger">{{$message}}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        id="tempat" name="tempat" value="{{old('tempat')??$hadirrapat->tempat}}" 
                                        autofocus required>
                                        @error('tempat')
                                            <div class="text-danger">{{$message}}</div>
                                        @enderror
