            		...
            		<div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 offset-md-4">
                                <form action="{{ route('daftarhasilkegiatans.update',['hasilkegiatan'=>$hasilkegiatan->id])}}" method="post">
                                    @method('PUT')
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        id="keterangan" name="keterangan" value="{{old('keterangan')??$hasilkegiatan->keterangan}}" 
                                        autofocus required>
                                        @error('keterangan')
                                            <div class="text-danger">{{$message}}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        id="tempat" name="tempat" value="{{old('tempat')??$hasilkegiatan->tempat}}" 
                                        autofocus required>
                                        @error('tempat')
                                            <div class="text-danger">{{$message}}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        @error('tanggal') is invalid @enderror" 
                                        id="tanggal" name="tanggal" value="{{old('tanggal')??$hasilkegiatan->tanggal}}" 
                                        autofocus required>
                                        @error('tanggal')
                                            <div class="text-danger">{{$message}}</div>
                                        @enderror
