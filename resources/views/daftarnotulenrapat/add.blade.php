            		...
            		<div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 offset-md-4">
                                <form action="{{ url('daftarnotulenrapat')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        id="agenda" name="agenda" value="{{old('agenda')}}" 
                                        autofocus required>
                                        @error('agenda')
                                            <div class="text-danger">{{$message}}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        <label for="file">File Notulen</label>
                                        <input type="file" class="form-control
                                        @error('file_notulen') is invalid @enderror" 
                                        id="file_notulen" name="file_notulen" value="{{old('file_notulen')}}" 
                                        >
                                        @error('file_notulen')
                                            <div class="text-danger">{{$message}}</div>
                                        @enderror
