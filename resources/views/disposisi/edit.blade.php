            ...
            <div class="animated fadeIn">
            	<div class="card">
            		...
            		<div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <form action="{{ url('disposisi/'.$disposisi->id)}}" method="post" enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        id="catatan_disposisi" name="catatan_disposisi" value="{{old('catatan_disposisi')??$disposisi->catatan_disposisi}}" 
                                        autofocus required>
                                    ...
                                    <div class="form-group">
                                       ...
                                       <input type="date" class="form-control 
                                        ...
                                        id="tanggal_verifikasi" name="tanggal_verifikasi" value="{{old('tanggal_verifikasi')??$disposisi->tanggal_verifikasi}}" 
                                        autofocus required>
