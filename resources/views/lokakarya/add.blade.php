            ...
            <div class="animated fadeIn">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <form action="{{ url('lokakarya/data')}}" method="post">
                                    @csrf                                   
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="text" name="nama_pelatihan" class="form-control @error('nama_pelatihan') is-invalid @enderror" value="{{ old('nama_pelatihan') }}">
                                    ...
                                    <div class="form-group">
                                        <label>Waktu</label>
                                        <input type="date" name="waktu" class="form-control @error('waktu') is-invalid @enderror" value="{{ old('waktu') }}">
                                        @error('waktu')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>LN/DN</label>
                                        <select type="text" name="ln_dn" class="form-control @error('ln_dn') is-invalid @enderror" value="{{ old('ln_dn') }}">
