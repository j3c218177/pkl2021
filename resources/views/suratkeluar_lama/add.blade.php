            ...
            <div class="animated fadeIn">
            	<div class="card">
            		...
            		<div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <form action="{{ url('suratkeluar')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        id="jawaban" name="jawaban" value="{{old('jawaban')}}" 
                                        autofocus required>
                                        @error('jawaban')
                                            <div class="text-danger">{{$message}}</div>
                                        @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        id="pengetik" name="pengetik" value="{{old('pengetik')}}" 
                                        autofocus required>
                                        @error('pengetik')
                                            <div class="text-danger">{{$message}}</div>
                                        @enderror
