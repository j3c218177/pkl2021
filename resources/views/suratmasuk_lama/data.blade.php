            	...
            	<div class="card">
        			...
        			<tbody>
						...
						<tr>
							...
							<td>{{$item->hal}}</td>
							<td><a href="{{asset('file/suratmasuk/'.$item->lampiran)}}" target="_blank" rel="noopener noreferrer"><i class="fa fa-file"></i></a></td>
							...
							<td class="text-center">
                                ...
                                <a href="{{ url('disposisi/view/'.$item->id)}}" class="btn btn-warning">
